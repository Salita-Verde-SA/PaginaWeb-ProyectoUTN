...
public class JwtConfig {
    ...
    @Value("${jwt.secret:MiSuperSecretKeyParaSalitaVerde2024DebeSerLargaYSegura}")
    private String secret;

    @Value("${jwt.expiration:2592000000}") // 30 días en milisegundos
    ...
    public Boolean validateToken(String token, String username, Integer currentTokenVersion) {
